    ...
    return (
        <div className="max-w-6xl mx-auto h-[400px] lg:h-[600px] md:h-[600px] relative">
          ...
          <div className="absolute flex-col inset-0 bg-gradient-to-l from-transparent to-black text-center flex items-center place-content-center ">
              <h2 className=" text-4xl lg:text-6xl md:text-6xl font-bold mb-5 font-Kanit" data-aos="fade-in" data-aos-duration="3000">T & G Event Management</h2>
              
              <p className="text-2xl lg:text-4xl md:text-4xl font-semibold font-Kanit" data-aos="fade-up" data-aos-duration="3000">"Unlocking Tech & Gaming Spectacles"</p>
