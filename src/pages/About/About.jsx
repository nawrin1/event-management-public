...
const About = () => {
    ...
    return (
        ...
        <div className="max-h-screen max-w-6xl mx-auto flex mt-28 mb-52" >
            ...
            <p className="text-xl text-gray-400 font-Kanit mt-6 text-justify " data-aos="zoom-in" data-aos-duration="2500"> "Our mission is to unite tech and gaming enthusiasts, fostering innovation, connections, and unforgettable experiences. We're dedicated to creating events that inspire and educate, driving progress in these dynamic industries."</p>
